    ...
    return (
        <div className='container'>
            ...
            <div className={styles.container_projects}>
                <div className={styles.project}>
                    <div className={styles.info}>
                        ...
                        <div className={styles.buttons}>
                            {/* <Link className='btn-color icon' >Ver projeto</Link> */}
                        </div>
              ...
              <Link to="https://mini-blog-eight-mu.vercel.app/" target="_blank" className='btn-color icon'>Ver projeto</Link>
                        </div>
                ...
                <div className={styles.project}>
                    <div className={styles.info}>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <Link to="https://todo-list-local-storage.vercel.app/" target="_blank" className='btn-color icon'>Ver projeto</Link>
                        </div>
                    </div>
                    <div className={styles.preview}>
                ...
                <div className={styles.project}>
                    ...
                    <div className={styles.info}>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <Link tp="https://cine-fan.vercel.app/" target="_blank" className='btn-color icon'>Ver projeto</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.project}>
                    <div className={styles.info}>
                        ...
                        <div className={styles.buttons}>
                            <Link to="https://github.com/JhonatanNeris/Tabuada" target="_blank" className='btn-outline icon'><span><FaGithub /></span>Ver código</Link>
                            <Link to="https://tabuada-sigma.vercel.app/" target="_blank" className='btn-color icon'>Ver projeto</Link>
                        </div>
                    </div>
                    <div className={styles.preview}>
